...
public:
    ...
    /**
     * Generate a board with the provided dimensions and probability.
     *
     * The board should be generated with the following rules:
     * - The board should be a square with the provided dimensions.
     * - The board should have a probability of the cell being BLOCKED as provided.
     * - The board should have the remaining cells EMPTY.
     */
    void generateBoard(int dimensions, float probability);
    /**
    ...
    */
    ...
    /*
        Display the generated board with the player
    */
    void displayGeneratedBoard(Player *player);
};
